...
public class StackItemTest {
  ...
  public void testGetters() {
    StackItem item = new StackItem(className, methodName, lineNumber, true, false);
  ...
  public void testEquals() {
    StackItem i1 = new StackItem(className, methodName, lineNumber, true, false);
    StackItem i2 = new StackItem(className, methodName, lineNumber, true, false);
    ...
    Assert.assertFalse(i1.hashCode() == new StackItem(className, methodName, lineNumber + 1, true, false).hashCode());
  }
